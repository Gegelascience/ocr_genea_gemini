...
export class GeminiLogAnalyseClient {
    ...
    formatAdvancedTable(data) {
        ...
        ${data.paragraphsBaptism.length > 0 ?`<h4 >Liste des baptêmes</h4>
        ...
        ${data.paragraphsBorn.length > 0 ?`<h4 >Liste des naissances</h4>
        ...
        ${data.paragraphsMariage.length > 0 ?`<h4 >Liste des mariages</h4>
        ...
        ${data.paragraphsDeath.length > 0 ?`<h4 >Liste des décès</h4>
            <table class="table table-hover table-secondary">
                <thead>
                    <tr>
                        <th>Décédé</th>
